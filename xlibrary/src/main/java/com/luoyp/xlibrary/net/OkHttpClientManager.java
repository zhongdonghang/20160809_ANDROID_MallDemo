package com.luoyp.xlibrary.net;
 ...
 * okhttp 管理类
 *
 * @author lyp3314@gmail.com on 15/9/28.
 */
...
public class OkHttpClientManager {
    ...
    public static void getAsyn(String url, Param[] params, ResultCallback callback, Object tag) {
        getInstance().getGetDelegate().getAsyn(url, params, callback, tag);
    }
    ...
    public class GetDelegate {
        ...
        public void getAsyn(String url, Param[] params, final ResultCallback callback, Object tag) {
            if (params == null) {
                params = new Param[0];
            }
