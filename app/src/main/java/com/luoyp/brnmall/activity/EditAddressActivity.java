...
public class EditAddressActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regionid = String.valueOf(userModel.getUserInfo().getRegionId());
        ...
        if (address.length > 0) {
            mProvinceView.setText(address[0]);
            mDiquView.setText(address[1]);
            mDetailView.setText(address[2]);
        }
