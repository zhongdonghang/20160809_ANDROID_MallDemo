...
public class AddMyAddressActivity extends BaseActivity {
    ...
    private EditText mNameView, mPhoneView, mChengshi, mProvinceView, mDiquView, mDetailView;
    ...
    public void showDialog(String name, String[] data, final String type) {
        AlertDialog.Builder builderSingle = new AlertDialog.Builder(AddMyAddressActivity.this);
        builderSingle.setIcon(R.mipmap.logo);
        builderSingle.setTitle(name);

        final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(
                AddMyAddressActivity.this,
...

                {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if ("3".equals(type)) {
                            ...
                            regionId = diquArea.get(which).getId();
                        }
